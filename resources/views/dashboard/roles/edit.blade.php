                            ...
                            <form class="form" action="{{ route('dashboard.roles.update' , $role->id) }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="userinput1">{{ __('dashboard.role_name-english') }}</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="userinput1"> {{ __('dashboard.role_name-arabic') }}</label>
                                                <input type="text" id="userinput1" class="form-control border-primary"
                                    ...
                                    <div class="row">
                                        @if (Config::get('app.locale') == 'ar')
                                            @foreach (config('permessions_ar') as $key => $value)
                                                <div class="col-md-2">
                                                    <input value="{{ $key }}" type="checkbox" name="permession[]"
                                ...
                                <div class="form-actions right">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="la la-check-square-o"></i>{{ __('auth.submit')}}
                                    </button>
                                </div>
                            </form>
                        </div>
