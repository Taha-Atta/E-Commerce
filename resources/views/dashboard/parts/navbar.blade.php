                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#"><i
                            ...
                            <form action="{{ route('dashboard.logout') }}" method="post">
                                @csrf
                                <button class="dropdown-item" type="submit"> <i class="ft-power"> </i>
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link"
                            ...
                            aria-expanded="false"><i
                                class="flag-icon @if (config('app.locale') == 'en') flag-icon-gb @else flag-icon-sa @endif"></i><span
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}"
                                    ...
                                    <i
                                        class="flag-icon @if ($localeCode == 'en') flag-icon-gb @else flag-icon-sa @endif"></i>
                                    {{ $properties['native'] }}
                                </a>
                            @endforeach
                        </div>
