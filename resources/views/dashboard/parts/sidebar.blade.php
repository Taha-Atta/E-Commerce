        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @can('roles')
                <li class=" nav-item"><a href="{{ route('dashboard.roles.index') }}"><i class="la la-television"></i><span
                            class="menu-title" data-i18n="nav.templates.main">{{ __('dashboard.roles') }}</span></a>
                    <ul class="menu-content">
                        ...
                        <li><a class="menu-item" href="{{ route('dashboard.roles.create') }}"
                                data-i18n="nav.templates.vert.compact_menu">{{ __('dashboard.create_role') }}</a>
                        </li>
                    </ul>
                </li>
            @endcan
                ...
                <li class=" nav-item"><a href="{{ route('dashboard.admins.index') }}"><i class="la la-television"></i><span
                    ...
                    <ul class="menu-content">
                        ...
                        <li><a class="menu-item" href="{{ route('dashboard.admins.create') }}"
                                data-i18n="nav.templates.vert.compact_menu">{{ __('dashboard.create_admin') }}</a>
                        </li>
                    </ul>
                </li>
            @endcan
            ...
            <li class=" nav-item"><a href="#"><i class="la la-puzzle-piece"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-1-column.html"
                            data-i18n="nav.starter_kit.1_column">1 column</a>
                    </li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-2-columns.html"
                    ...
                    <li><a class="menu-item" href="#"
                        ...
                        <ul class="menu-content">
                            <li><a class="menu-item"
                                    href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-content-detached-left-sidebar.html"
                                    data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_left_sidebar">Detached
                                    left sidebar</a>
                            </li>
                            <li><a class="menu-item"
                                    href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-content-detached-left-sticky-sidebar.html"
                                    data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_sticky_left_sidebar">Detached
                                    sticky left sidebar</a>
                            </li>
                            <li><a class="menu-item"
                                    href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-content-detached-right-sidebar.html"
                                    data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_right_sidebar">Detached
                                    right sidebar</a>
                            </li>
                            <li><a class="menu-item"
                                    href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-content-detached-right-sticky-sidebar.html"
                    ...
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-fixed-navbar.html"
                            data-i18n="nav.starter_kit.fixed_navbar">Fixed navbar</a>
                    </li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-fixed-navigation.html"
                            data-i18n="nav.starter_kit.fixed_navigation">Fixed navigation</a>
                    </li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-fixed-navbar-navigation.html"
                            data-i18n="nav.starter_kit.fixed_navbar_navigation">Fixed navbar &amp; navigation</a>
                    </li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-fixed-navbar-footer.html"
                            data-i18n="nav.starter_kit.fixed_navbar_footer">Fixed navbar &amp; footer</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-fixed.html"
                            data-i18n="nav.starter_kit.fixed_layout">Fixed layout</a>
                    </li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-boxed.html"
                            data-i18n="nav.starter_kit.boxed_layout">Boxed layout</a>
                    </li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-static.html"
                            data-i18n="nav.starter_kit.static_layout">Static layout</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-light.html"
                            data-i18n="nav.starter_kit.light_layout">Light layout</a>
                    </li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-dark.html"
                            data-i18n="nav.starter_kit.dark_layout">Dark layout</a>
                    </li>
                    <li><a class="menu-item"
                            href="../../../starter-kit/rtl/vertical-modern-menu-template/layout-semi-dark.html"
